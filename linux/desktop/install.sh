...
sudo apt install i3 i3lock suckless-tools i3status dmenu i3lock xbacklight feh conky conky-manager pasystray paman paprefs pavumeter pulseaudio-module-zeroconf pavucontrol variety numlockx lxappearance scrot terminator -y
